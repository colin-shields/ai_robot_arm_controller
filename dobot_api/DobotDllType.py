...
PTPMode = enum(
    PTPJUMPXYZMode=0,       # Jump, XYZ coords
    PTPMOVJXYZMode=1,       # Fast move(?), XYZ coords
    PTPMOVLXYZMode=2,       # Normal move, XYZ coords
    
    PTPJUMPANGLEMode=3,     # Honestly no clue but probably angles??
    PTPMOVJANGLEMode=4,
    PTPMOVLANGLEMode=5,
...
def load():
    if platform.system() == "Windows":
        ...
        return CDLL("./dobot_api/DobotDll.dll",  RTLD_GLOBAL)
